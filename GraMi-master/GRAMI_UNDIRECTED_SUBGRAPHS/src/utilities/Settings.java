...
public class Settings 
{
	...
	public static int maxNodes = 10000;
	public static int maxEdges = 10000;
	...
	public static String outputFileName = "Output.subgraphs";

	public static String outputFileName2 = "Output.txt";
}
